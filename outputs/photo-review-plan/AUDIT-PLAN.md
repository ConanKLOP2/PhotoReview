...
|---|---|---|---|---|
| A | Source inventory bắt đầu | A01 | A02 build/review | — |
| B | Config legacy + action JSON tồn tại | B01 | B02 editor UI | UI hiện còn JSON thủ công |
| C | Name/PortraitFirst, compare cơ bản tồn tại | C01 | C02 test pair/EXIF | Chưa có GUI acceptance |
| D | Move/Copy/Recycle/hash batch cơ bản tồn tại | D01 | D02/D03 dry-run | Batch hiện cần tăng safety/preview |
| E | LRU/preload/preview cache tồn tại | E01 | E02 telemetry | Chưa có benchmark định lượng |
| F | Build đã PASS trước đó | F01 | F02/F03 | Cần fixture và test GUI |
