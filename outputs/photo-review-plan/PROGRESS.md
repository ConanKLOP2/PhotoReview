...
| 2026-09-14 | Native Explorer order dùng COM vtable, hiển thị ảnh fallback trước khi chờ Shell, reindex và làm mới counter theo native order, tách folder generation, thêm version gate và publish 1.0.1 | Native Name DESC probe PASS; `verify-all.ps1` + self-contained verification PASS; SHA256 `C80E9B23...` |
