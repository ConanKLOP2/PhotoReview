...
public static class SecondInstanceHandoff
{
    ...
    /// <summary>True when the running instance took over (or, Q-R12, very likely took over) the request and this process can simply exit.</summary>
        ...
        IInstanceForwardClient client, IReadOnlyList<string> existingPaths, TimeSpan timeout, ILog? log = null, CancellationToken cancellationToken = default)
    {
        ...
        return outcome is ForwardOutcome.Delivered or ForwardOutcome.Unknown;
    }
}
