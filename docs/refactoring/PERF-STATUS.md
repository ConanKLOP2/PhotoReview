...
- **Next:** repeat on an idle machine; test "cold bitmap memory" directly (whole-folder mode on a small folder vs F4; ETW hard/soft faults and memory-compression activity during navigation).
