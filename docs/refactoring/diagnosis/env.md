...
Người dùng sẽ cung cấp đường dẫn root cho từng fixture. Lưu mapping tại `docs/refactoring/diagnosis/fixture-mapping.txt` (không commit vào repo; dùng local).
