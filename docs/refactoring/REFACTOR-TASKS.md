...
- **Nhật ký:** 2026-09-20 — Follow-up GUI xác nhận Fit lần đầu gần đúng, lần hai mới chuẩn. Đã triển khai Fit convergence tối đa 3 lượt và cập nhật viewport khi ảnh/current presentation đổi. Follow-up tiếp theo sửa wheel ngay sau Fit: không dùng tỷ lệ zoom danh nghĩa; map con trỏ từ vùng Uniform/letterbox về tọa độ ảnh nguồn rồi bù theo vị trí thật trước/sau layout. Targeted 19/19, full xUnit 743/743, smoke, fault injection, publish + verify-release PASS. Chờ GUI acceptance.
