...
| **AR** (Architecture Review 2026-09-26) | 🔄 AR11, AR12, AR13, AR14a, AR15, AR17a, AR18a, AR19a merged (#106); AR16 (Q-AR7 c) merged (#107); AR10 closed (Q-AR6 a); benchmark speed-up #109; only AR13/AR16 GUI check left (user) | Summary: `refactoring/ARCH-REVIEW-2026-09-26-SUMMARY.md`. |
...
- **Review 2026-09-25 waves:** all of 1a–1c, 2a, 2b (minus TEST-03, declined), 3, 4, 5a–5c plus round-2 fixes are merged (#76). Round 2 decided (Q-R7..Q-R11): #77, #78, #79 open.
