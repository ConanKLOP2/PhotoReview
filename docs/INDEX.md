...
|------|---------|------|------|-----------|
| **AGENTS.md** | Rules for work mode, process, agent behavior | T0 | 5.7 KB | Startup, always |
| **task_on_progress.md** | Current status, blockers, critical rules | T0 | 3.8 KB | Startup, always |
| **docs/ACTIVE-TASKS.md** | Consolidated open tasks across all groups | T0 | 13 KB | Startup, for task context |
...
| **docs/adr/*.md** | Architecture decisions (0001-0005; 0005 Proposed) | T1 | 25 KB | When working in relevant area |
| **docs/refactoring/ARCH-REVIEW-SUMMARY.md** | Architecture review 2026-09-23: findings F1-F9, AR task table, order | T1 | 7 KB | Before any AR task or boundary change |
| **docs/refactoring/arch-review/AR0x-*.md** | Step-by-step plan per AR task (files, lines, tests, acceptance) | T1 | 3-14 KB each | Only the file of the AR task you work on |
...
| **docs/refactoring/OPEN-DECISIONS.md** | All Q-* decisions consolidated (incl. Q-AR1..5) | T1 | 3 KB | For decision lookup |
