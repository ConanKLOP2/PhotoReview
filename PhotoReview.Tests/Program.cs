...
try
{
    ...
    Check(mainWindowXaml.Contains("<Grid.RowDefinitions><RowDefinition Height=\"Auto\"/><RowDefinition Height=\"*\"/><RowDefinition Height=\"Auto\"/></Grid.RowDefinitions>") && mainWindowXaml.Contains("<Border Grid.Row=\"0\" Panel.ZIndex=\"100\"") && mainWindowXaml.Contains("<Border Grid.Row=\"1\" Background=\"#101010\""), "Top toolbar occupies a dedicated row above the image", failures);
