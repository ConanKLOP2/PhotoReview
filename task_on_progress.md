...
- D12/D13 DONE: `docs/refactoring/diagnosis/REPORT.md` đã được người dùng đọc và xác nhận; `REFACTOR-PLAN.md`, `REFACTOR-TASKS.md`, `PERF-DIAGNOSIS-TASKS.md` đã đồng bộ thứ tự. Tiếp theo là T67 cleanup compatibility marker; T87 làm setting + fallback với WPF default; T65 BLOCKED đến sau T87/T66.
