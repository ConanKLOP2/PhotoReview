...
- T65 DONE: `SourceBytesCache` LRU/dedup/generation clear/evict, flag `UseSourceBytesCache=false`, capacity 16 GiB; Preview decode, FileHashService, PreloadScheduler và ThumbnailCache JPEG dùng cache khi bật; PNG/WIC giữ stream fallback. Test cache 2/2, ThumbnailCache 3/3, full verify PASS (203 Imaging, 163 App), publish/verify-release PASS. Mặc định vẫn tắt theo Q5.
