...
- T52 chưa thể hoàn tất trong phạm vi Files hiện tại: compatibility marker trong `MainWindow.xaml.cs` vẫn được 10 source-presence tests kiểm tra, còn yêu cầu bind `PerformanceOptions` cần thêm AppSettings/settings wiring ngoài các file đang liệt kê. Đã dừng trước khi mở rộng phạm vi; cần plan/approval mới cho phần này.
