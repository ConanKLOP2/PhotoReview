...
- **Plan:** `docs/refactoring/OPTIMIZE-CLEAN-PLAN-2026-09-20.md`; OC02/OC03/OC04/OC05/OC07-subset/OC10 đã `DONE`, các task khác vẫn `TODO` hoặc chờ evidence.
...
- `tools/verify-all.ps1` PASS sau wave hai: 7 Architecture + 307 Core + 205 Imaging + 60 Integration + 173 App = 752/752; smoke, fault-injection, publish và verify-release PASS.

## Quyết định và việc còn lại

1. OC02/OC03/OC04/OC05/OC07-subset/OC10 đã triển khai và commit; còn UI-thread boundary, T89 layout acceptance, journal/recovery/session, folder I/O, benchmark semantics và đo tối ưu.
...
- Commit implementation: `4a81ba8` preload, `6a4ec01` decoder, `00cad65` duplicate, `3db9ae6` cache, `5edd15d` display, `b8b97fb` PerfAnalyze grouping, `ecdbf2b` test seam. Tài liệu plan và file này được cập nhật sau validation.
