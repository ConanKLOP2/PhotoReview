...
- **Cập nhật:** 2026-09-19 | **Branch làm việc:** `refactor/integration` · VERIFY đạt, xUnit 668/668 (Core: 245, Imaging: 144, Integration: 8, Architecture: 5 (+1 skip), App.Tests: 10, Tests.Unit: 256)
...
1. **Đang thực hiện cụm 4 task Wave W4 đã được duyệt:**
   ...
   - **T43a (`ShortcutRouter`) ∥I:** TIẾP THEO (Định tuyến phím tắt độc lập UI).
   - **T43b (`ViewerState`) ∥I:** TIẾP THEO (Quản lý trạng thái xem ảnh).
