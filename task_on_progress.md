...
- Plan giảm token đọc codebase: `docs/refactoring/DOCS-TOKEN-DIET-PLAN-2026-09-20.md` (DT00–DT10), **chưa triển khai**. Số đo: docs 564 KB (~190k token ước lượng), 5 file lịch sử/kế hoạch chiếm ~59%; cold start theo hướng dẫn hiện tại ≈ 126 KB. Cần quyết định Q-D1..Q-D4 (sửa `AGENTS.md`, `git mv` vào `docs/archive/`, `CLAUDE.md`, `.ignore`).
