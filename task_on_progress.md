...
- **Cập nhật:** 2026-09-19 | **Branch làm việc:** `refactor/T46c-mainviewmodel-advanced` -> `refactor/integration` · VERIFY đạt, xUnit 746/746 (Core: 245, Imaging: 144, Integration: 8, Architecture: 6 (Rule 6 K-2 enabled, 0 skipped), App.Tests: 87, Tests.Unit: 256)
...
1. **Lựa chọn task tiếp theo:**
   - **T46d (`MainWindow binding, rút gọn code-behind`):** Hoàn thiện liên kết MVVM, bind toàn bộ UI/Command với `MainViewModel`, đưa code-behind `MainWindow.xaml.cs` xuống ≤ 250 dòng.
