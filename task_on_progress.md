...
- **UI feedback Q-R29:** arrow-key pan #119 merged; the rest (dark chrome, toolbar auto-hide, context menu, title-bar fields, Modified date EXIF field, font size, click-zoom `2`, glide smoothing `Predict`) in `integration/ui-feedback` — user GUI check pending. #109 GUI check: OK.
