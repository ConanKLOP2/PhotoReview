...
- **Preload window configurable (Q-R30, `feat/preload-window-setting`):** Settings ▸ Performance, forward/backward lookahead (32/8, 1-500/0-500); RAM floor follows it, applies after restart.
